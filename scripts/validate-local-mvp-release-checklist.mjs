...
assert(
  settingsAgentsServerUiSource.includes('settings-local-model-simple')
    ...
    && settingsAgentsServerUiSource.includes('project-dashboard-view')
...
assert(
  appSource.includes('settings-secret-vault-action-required')
    ...
    && appSource.includes('const startupAllowsConfiguredModel = (readiness) => initiationStartupAllowsModelWork({')
    && appSource.includes('if (!startupAllowsConfiguredModel(startupReadiness))')
    && appSource.includes('startupAllowsConfiguredModel(startupReadiness) || isDevelopmentInitiationFallbackEnabled()')
    ...
    && appSource.includes('const initiationStartupReadyForFirstRun = initiationStartupAllowsModelWork({')
    && appSource.includes('modelProviderStatus: providerRuntimeStatus.modelProvider,')
