...
export default function ProjectDashboardAgentContractRoutes({ view = {} }) {
  const {
    hasAgent,
    onOpenDashboard,
    onOpenTimeline,
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-1 font-mono text-[8px] uppercase text-[#7d6a49] leading-relaxed">
            Agent contracts / {summary.readyCount ?? 0} ready of {summary.count ?? 0} routes / {summary.activeCount ?? 0} active
          </div>
