...
export const globalStyles = `
  ...
  @keyframes password-valid-check-in {
    0% { opacity: 0; transform: scale(0.35) rotate(-18deg); }
    58% { opacity: 1; transform: scale(1.18) rotate(4deg); }
    100% { opacity: 1; transform: scale(1) rotate(0deg); }
  }
  .password-valid-check {
    animation: password-valid-check-in 420ms cubic-bezier(0.16, 1, 0.3, 1) both;
    filter: drop-shadow(0 3px 7px rgba(79, 122, 69, 0.24));
  }
